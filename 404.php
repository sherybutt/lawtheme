...
function genesis_404() {
	...
	echo genesis_html5() ? '<article class="entry">' : '<div class="post hentry">';
		...
		printf( '<div class="errorIcon"><i class="fas fa-exclamation-triangle"></i></div><h1 class="entry-title">%s</h1>', apply_filters( 'genesis_404_entry_title', __( 'Not found, error 404', 'genesis' ) ) );
		echo '<div class="entry-content">';
			...
			if ( genesis_html5() ) :
				...
				get_search_form();
echo do_shortcode('[wp_sitemap_page only="page"]');
