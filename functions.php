...
function genesis_sample_enqueue_scripts_styles() {
    ...
    //Enqueue Font Awsome Library
    wp_enqueue_style( 'font-awsome', '//use.fontawesome.com/releases/v5.7.1/css/all.css');
    wp_enqueue_script( 'custom-js', get_stylesheet_directory_uri() . '/inc/js/custom.js', array('jquery'), TRUE );    
